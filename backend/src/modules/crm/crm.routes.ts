...
import { listCustomers, getCustomer, addNote, createTask, addMemberToCRM } from './crm.controller';
...
router.post('/members', authenticate, authorize(UserRole.ADMIN, UserRole.COACH), validate(memberSchema), addMemberToCRM);
